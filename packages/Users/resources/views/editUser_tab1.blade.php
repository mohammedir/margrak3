                    ...
                    <div class="register-line">
                        ...
                        <select name="fk_i_role_id" id="fk_i_role_id" class="form-control">
                            @foreach($roles->getChilds as $c)
                                <option {{$user_details->fk_i_role_id == $c->pk_i_id ? "selected" : ""}} value="{{$c->pk_i_id}}">{{$c->s_name_ar}}</option>
                            @endforeach
                            @foreach($mtgers  as $c)
                                <option {{$user_details->fk_i_role_id == $c->pk_i_id ? "selected" : ""}} value="{{$c->pk_i_id}}">أعضاء {{$c->s_name_ar}}</option>
                            @endforeach
