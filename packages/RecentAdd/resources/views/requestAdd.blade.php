@extends("_outLayout")
@section("body")
    <form action="" method="post" id="requestAddForm">
        {{csrf_field()}}
        <div class="container">
            <div class="row">
                <div class="register-box">
                    <div class="top-ad">
                        ...
                        <div class="row second-row">
                            <div class="col-md-8">
                                <select id="i_type" name="i_type" class="form-control">
                                    <option disabled selected>حدد نوع إعلانك</option>
                            ...
                            <div class="col-md-4">
                                <select name="i_contact_method" class="form-control">
                                    @if(session("user_id"))
                                        <option value="0">عبر الموقع</option>
                                        <option value="1">{{Auth::user()->s_mobile_number}}</option>
                                        <option value="2">{{Auth::user()->s_email}}</option>
                                    @endif
                                </select>
                    ...
                    <div class="mid-ad">
                        <div class="container">
                            <p id="para">قم بكتابة تفاصيل طلبك بشكل كامل وواضح :</p>
                    ...
                    $.ajax({
                        ...
                        success: function (data, textStatus, jqXHR) {
                            ...
                            if (data[0].status == 1) {
                                ...
                                window.location.href = "{{url("/")}}/requestAdd";
                            }
                        }
                        ,
                        error: function (jqXHR, textStatus, errorThrown) {
