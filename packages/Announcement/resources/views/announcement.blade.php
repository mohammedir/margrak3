                ...
                <div class="manage-content">
                    <div class="manage-content-show">
                        <div class="manage-title">
                            ...
                            <a class="btn btn-success" style="float:left;color:#fff;" href="{{url("/")}}/addAnnouncement">
                                + اعلان جديد</a>
                            <div class="row">
                                <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary"
                                                   href="{{url("/")}}/editAnnouncement/{{$c->pk_i_id}}">تعديل</a>
                                                <a class="btn btn-danger Confirm"
                                                   href="{{url("/")}}/deleteAnnouncement/{{$c->pk_i_id}}">حذف</a>
                                            </td>
                                        </tr>
                                    @endforeach
                                    </tbody>
