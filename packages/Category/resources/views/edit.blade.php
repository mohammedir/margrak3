    ...
    <form id="add_category_form" action="" method="post" enctype="multipart/form-data">
        ...
        <div class="col-sm-10 col-xs-12">
            <section class="manage-content">
                ...
                <a href="{{url("/")}}/categories/delete/{{$record_data->pk_i_id}}" class="btn btn-danger Confirm "
                   style="float: left "><i
                            class="fa fa-trash"></i> حذف القسم</a>
                <div class="row">
                ...
                ?>
                @if($my_flag)
                    <div id="key_word_div" class="row ">
                        <div class="form-group">
                            <label class="control-label">يرجى كتابة الكلمات الدلالية مفصولة بفاصلة. مثال:
                                تويوتا,لزكس</label>
                            <div class="selectContainer">
                                <div class="input-group">
                                <textarea type="form-control" name="key_word"
                                          id="key_word">@foreach($key_words as $k){{$k->key_word.","}}@endforeach</textarea>
                                    <div style="color:red" id="main_cat_error" class="font-red bold hidden">حقل مطلوب
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-2 the-color">
                            <input value="{{$record_data->s_tape_color}}" type="text" id="cat_color1" name="cat_color1"
                ...
                <div class="row">
                    <div class="form-group">
                        <label class="control-label">اظهار / اخفاء شريط المساحات الاعلانية ؟
                            <input {{$record_data->b_has_ads_space == 1 ? "checked" : ""}} type="checkbox"
                                   name="b_has_ads_space">
                        </label>
                    </div>
                </div>
