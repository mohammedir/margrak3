<div class="col-sm-10 hide-show">
    ...
    <div class="single-check">
        ...
        <input class="myCheckBox"
               ...
               type="checkbox" name="Accept" value="{{$NEW_ADS_BAR->pk_i_id }}"><span>{{$NEW_ADS_BAR->s_name_ar }}</span>
    </div>
    <div class="single-check">
        <input class="myCheckBox"
    ...
    <div class="single-check">
        <input class="myCheckBox"
                ...
                type="checkbox" name="Accept" value="{{$ADS_FILTERS->pk_i_id }}"><span>{{$ADS_FILTERS->s_name_ar }}</span>
    </div>
</div>
<script>
    $(function () {
