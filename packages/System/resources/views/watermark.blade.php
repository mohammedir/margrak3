...
@section("body")
            ...
            <section class="manage-content">
                ...
                <div class="row" style="margin: 20px 0px;">
                    <div class="col-md-4 text-center">
                        <label for="">حجم الشعار (%)</label>
                        <input name="LOGO_WATERMARK_WIDTH"
                               value="{{$LOGO_WATERMARK_WIDTH->s_value == null ? "" : $LOGO_WATERMARK_WIDTH->s_value}}"
                               id='rng2'/>
                        <label for="">الشفافية</label>
                        <input name="LOGO_WATERMARK_TRANSPARENCY"
                               value="{{$LOGO_WATERMARK_TRANSPARENCY->s_value == null ? "" : $LOGO_WATERMARK_TRANSPARENCY->s_value}}"
                               id='rng1'/>
                        <img src="{{url("/")}}/assets/img/2.jpeg" width='300'>
                        <img id="img1"
                             ...
                             style='opacity:{{$LOGO_WATERMARK_TRANSPARENCY->s_value == null ? ".54" : $LOGO_WATERMARK_TRANSPARENCY->s_value}}; position: absolute;top: 60%;right: 35%;width: {{$LOGO_WATERMARK_WIDTH->s_value == null ? "100" : $LOGO_WATERMARK_WIDTH->s_value}}%;'/>
                    </div>
                </div>
    ...
    <script>
        $(function () {
            ...
            rng1.on("change", function () {
                var value = $(this).prop("value");
                $('#img1').css('width', value + "%");
            });
        });
    </script>
@endsection