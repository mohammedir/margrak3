                    ...
                    <div class="form-group">
                        ...
                        <div class="inputGroupContainer">
                            <div class="input-group">
                                <input id="category_name" name="category_name" placeholder="عنوان القسم" class="form-control" type="text">
                                <div style="color:red" id="category_name_error" class="font-red bold hidden">حقل مطلوب</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="selectContainer">
                            <div class="input-group">
                                ...
                                <div style="color:red" id="category_type_error"  class="font-red bold hidden">حقل مطلوب</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="selectContainer">
                            <div class="input-group">
                                ...
                                <div style="color:red" id="cat_status_error" class="font-red bold hidden">حقل مطلوب</div>
                            </div>
                        </div>
                    </div>
                </div>
