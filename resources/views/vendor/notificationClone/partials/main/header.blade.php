                    ...
                    <li class="dropdown dropdown-extended dropdown-notification dropdown-dark"
                        ...
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown"
                           data-close-others="true">
                            <i class="icon-bell"></i>
                            <span class="badge badge-default notificationCounter hidden">0</span>
                        </a>
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <ul class="dropdown-menu-list scroller" style="height: 250px;"
                                    ...
                                    <li class="notificationPanelClone notification">
                                        <a href="javascript:;"
                                           style="background-color: {{env('NOTIFICATION_UNSEEN_COLOR')}}">
                                            <input value="" type="hidden" class="notificationId"/>
                                            <span class="time">just now</span>
                                                    <span class="details">
                                                     <img class="image hidden"
                                                          src="{{asset('assets/pages/media/users/avatar7.jpg')}}"
                                                          style="max-width: 50px !important; border-radius: 30px !important;"/>
                                                        <span class="content" style="padding-right: 8px !important;">New user registered.</span>
                                                    </span>
                                        </a>
                                    </li>
                                    @foreach($notifications as $notification)
                                        <li class="notification">
                                            <a href="javascript:;"
                                               style="background-color: @if($notification->status == 1 ){{env('NOTIFICATION_SEEN_COLOR')}} @else {{env('NOTIFICATION_UNSEEN_COLOR')}} @endif ; color:@if($notification->status == 1 ){{env('NOTIFICATION_UNSEEN_COLOR')}} @else {{env('NOTIFICATION_SEEN_COLOR')}} @endif ;">
                                                <input value="{{$notification->id}}" type="hidden"
                                                       class="notificationId"/>
                                                <span class="time"
                                                      style="  @if(json_decode($notification->content)->img) margin-top:10px !important; @endif
                                                              background-color: @if($notification->status == 1 ){{env('NOTIFICATION_SEEN_COLOR')}} @else {{env('NOTIFICATION_UNSEEN_COLOR')}} @endif ; color:@if($notification->status == 1 ){{env('NOTIFICATION_UNSEEN_COLOR')}} @else {{env('NOTIFICATION_SEEN_COLOR')}} @endif ;">{{str_replace(['ago' ,'منذ'] , '' ,$notification->created_at->diffForHumans())}}</span>
                                                    <span class="details">
                                                        {{--{{json_decode($notification->content)->img}}--}}
                                                        @if(json_decode($notification->content)->img)
                                                            <img class="image"
                                                                 src="{{asset(json_decode($notification->content)->img)}}"
                                                                 style="max-width: 50px !important; border-radius: 30px !important;"/>
                                                        @endif

                                                        <span class="content"
                                                              style="padding-right: 8px !important;">{{json_decode($notification->content)->content}}</span>
                                                    </span>
                                            </a>
                                        </li>
