            ...
            <div class="mid-register">
                ...
                <span class="input-group-btn">
                    ...
                    <div class="btn btn-default image-preview-input">
                        ...
                        <input type="file" accept="image/png, image/jpeg, image/gif" name="pic" id="pic"/>
                    ...
                    <div class="register-line">
                        <div class="row">
                            <div class="col-md-4">
                                <p>الاسم الاول</p>
                                <input name="f_name" placeholder="اكتب الاسم الاول">
                            </div>
                            <div class="col-md-4">
                                <p>الاسم الاخير</p>
                                <input name="l_name" placeholder="اكتب الاسم الاخير">
                            </div>
                        </div>
                    </div>
                    <div class="register-line">
                        ...
                        <input name="mobile" placeholder="مثال : 955661234567">
                    </div>
                    <div class="register-line">
                        <p>اختر السؤال السري</p>
                        <span>* هذا السؤال يظهر لك لاحقاً في حال تم سرقة الحساب او نسيت بيانات الدخول</span><br><br>
                        <select name="fk_i_secret_question_id" class="form-control">
                            <option disabled selected>إختار من القائمة</option>
                            @foreach($secret_questions as $s)
                                <option value="{{$s->pk_i_id}}">{{$s->s_name_ar}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="register-line">
                        <p>اكتب الجواب السري</p>
                        <span>* اكتب الجواب الذي تريد مع مراعاة الحروف والمسافات</span><br><br>
                        <input name="s_secret_question_answer" placeholder="اكتب الجواب السري">
                    </div>
                </div>
            </div>
