        ...
        <div class="register-box">
            ...
            <div class="mid-register">
                <div class="container">
                    ...
                    <div class="register-line">
                        <p>البريد الالكتروني <span>سيتم ارسال كود تفعيل الحساب عليه</span></p>
                    ...
                    <div class="register-line">
                        <p>كلمة السر <span>نرجو منك كتابة كلمة سر قوية تحتوي على حروف كبيرة وحروف صغيرة وأرقام ورموز</span></p>
                    ...
                    <div class="register-line">
                        ...
                        <input id="password_confirm" name="password_confirm"  type="password" placeholder="اكتب كلمة السر مرة اخرى">
                    ...
                    <div class="check">
                        <input type="checkbox" name="accept" id="accept" value="Agree"> اقر  بالموافقة والالتزام بـ <a>قوانين واحكام وشروط الموقع</a><br>
