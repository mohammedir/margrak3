            ...
            <section class="manage-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="inputGroupContainer">
                            <div class="input-group">
                                <input id="title" name="title" placeholder="العنوان" class="form-control" type="text">
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="inputGroupContainer">
                            <div class="input-group">
                                <input id="url" name="url" placeholder="رابط الاعلان" class="form-control" type="text">
                ...
                <div class="row">
                    <div class="form-group">
                        ...
                        <label for="selectAll">
                            <input type="radio" name="category_id" id="selectAll"
                                   value="selectAll"> جميع الأقسام
                        </label>
                        <label for="special">
                            <input type="radio" name="category_id" id="special" value="special">
                            قسم مخصص
                        </label>
                ...
                <br>
                <div id="category_div" class="hidden">
                                        ...
                                        <div class="manage-types">
                                            ...
                                            <div class="types-show">
                                                @foreach($c1->getChilds as $c2)
                                                    <input {{$c2->b_has_ads_space == 1 ? "checked" : ""}} type="checkbox"
